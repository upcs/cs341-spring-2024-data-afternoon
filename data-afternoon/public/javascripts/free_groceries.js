...
$.post(localurl, function(combinedResults, status) {
    ...
    let htmlContent = '<h1>Free Groceries</h1><div class="service-container">';

    // Iterate over each shelter in the safeYearRoundShelters array
    combinedResults[1].forEach(shelter => {
    ...
    document.getElementById("free-groceries").innerHTML = htmlContent;
